...
# Defaults (A4, 2 cm margins, fonts) come from md2pdf.yaml next to this script; md2pdf.typ makes tables breakable.
# --wrap=none: pandoc wrapped a "/ " onto a line start in the Typst source on 2026-09-19 and typst read it as a term-list item.
