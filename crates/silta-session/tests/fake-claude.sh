...
# result), hang (the turn never ends), agents (the turn starts a background agent that
# the level signal drops two seconds after the turn), busy (a turn that writes another memory note ends first, as
