...
call("send_file", {"room_id": "!r:localhost", "path": "/abs/report.md", "caption": "the report", "reply_to": "$a3", "more": False}, {"ok": True, "event_id": "$new4"})
...
call("send_file", {"room_id": "!r:localhost", "path": "relative.txt", "more": False}, {"ok": False, "error": "file_error", "message": "relative.txt is not an absolute path"})
